...
erica_action_module_msgs::IsRunning  g_is_running_srv;
...
void actionScriptPlayThreadFunc(int action_script_index)
{
  try
  {
    ...
    erica_action_module_msgs::StartAction start_action_msg;
...
{
  ros::init(argc, argv, "erica_action_script_player");
  ...
  g_start_action_pub      = ros_node_handle.advertise<erica_action_module_msgs::StartAction>("/heroehs/action/start_action", 0);
  ...
  ROS_INFO("Start ERICA Action Script Player");
